...
import os
import tempfile
from fileops.file_diff import process_file_diff
...
class TestFileDiff(unittest.TestCase):
    ...
    def test_basic_diff(self):
        ...
        self.assertEqual(result[0], ['2', 'B', 'Y'])
        self.assertEqual(result[1], ['4', 'D', 'W'])
    ...
    def test_case_sensitive(self):
        ...
        # Test case-sensitive (should find difference)
        result = process_file_diff(
            self.left_file,
            self.right_file,
            left_columns='1',
        ...
        # Test case-insensitive (should not find difference)
        result = process_file_diff(
            self.left_file,
            self.right_file,
            left_columns='1',
